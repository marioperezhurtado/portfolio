...
description: "A brief introduction to Rust's most interesting language features, from a web developer perspective. Inmutability, pattern matching, error handling, null references, and more."
pubDate: 'Jul 07 2023'
image: 'rust-is-really-cool.webp'
---

As a front-end/full-stack TypeScript developer, I wanted to explore a completely different language, stepping out of my comfort zone and exploring new ways of doing things.
...
Comparing it to TypeScript, we can see the strength and correctness of this solution.
...
There are a few libraries that try to solve this exact problem, but they are not part of the language itself.
