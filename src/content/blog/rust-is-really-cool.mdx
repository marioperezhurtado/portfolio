...
Learning Rust can be challenging, but it's worth the effort. Rust is a strict language with a steep learning curve; however, this design choice helps developers understand its complexity early on and avoid bugs in the future. Keep this in mind before starting to learn Rust.

All the topics we have discussed, and many more advanced features that I have yet to learn, make Rust a robust, elegant, and powerful language. Although I will probably not use it at work, I have found it a very enjoyable language. It has changed my view on software development and how things can be done in many different ways, and most importantly, it has been **really fun**.🦀
