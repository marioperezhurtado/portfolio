...
There are a few libraries that try to solve this exact problem in TypeScript,
but they are not part of the language itself, they have performance
implications, limitations and other caveats.
