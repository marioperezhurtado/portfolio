...
UI](https://headlessui.com/) are quite useful. They help us build fully accessible
...
This same concept can be used to think about *progressive enhancement*. If
frameworks give us **good defaults**, and buil on top of the **web platform**,
we can improve the resilience and availability of our applications, without having to change the way we develop.
...
In this example I will be using [SvelteKit](https://kit.svelte.dev/), but there are
other frameworks that share similar patterns, like [Remix](https://remix.run).
