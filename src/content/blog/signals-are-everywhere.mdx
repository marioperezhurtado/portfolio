...
Yes, it is that simple, move it out of the component. **State and component
lifecycle are not tied together.** 
...
easier to use, so we don't have to manually create elements and update their
values. Let's use **JSX**. Our final result should look like this:
...
have achieved a (very) basic version of a **VDOM-less, signal-based UI library**.
...
want to keep learning more about this topic. I hope you enjoyed this article, learned something new, and most importantly, **had fun!**
...
Carniato](https://twitter.com/ryansolid) and the [Solid](https://www.solidjs.com/)
